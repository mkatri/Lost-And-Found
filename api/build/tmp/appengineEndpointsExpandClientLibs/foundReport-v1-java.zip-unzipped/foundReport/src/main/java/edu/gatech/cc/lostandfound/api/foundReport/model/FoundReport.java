...
package edu.gatech.cc.lostandfound.api.foundReport.model;

/**
 * Model definition for FoundReport.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the foundReport. For a detailed explanation see:
...
public final class FoundReport extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private com.google.api.client.util.DateTime lossWindowBegin;

  /**
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key
  private com.google.api.client.util.DateTime lossWindowEnd;
   ...
   * @return value or {@code null} for none
   */
  public com.google.api.client.util.DateTime getLossWindowBegin() {
    return lossWindowBegin;
  }

  /**
   * @param lossWindowBegin lossWindowBegin or {@code null} for none
   */
  public FoundReport setLossWindowBegin(com.google.api.client.util.DateTime lossWindowBegin) {
    this.lossWindowBegin = lossWindowBegin;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public com.google.api.client.util.DateTime getLossWindowEnd() {
    return lossWindowEnd;
  }

  /**
   * @param lossWindowEnd lossWindowEnd or {@code null} for none
   */
  public FoundReport setLossWindowEnd(com.google.api.client.util.DateTime lossWindowEnd) {
    this.lossWindowEnd = lossWindowEnd;
    return this;
  }
